...
os.system("python show_result.py --gpus 0 --n 2 --t 0.6 --embed ../pkl/rejection/Reject_embed.pkl --classifier ../pkl/rejection/Reject_params.pkl --rejection Y")
...
os.system("bash code/pre_train_script.sh")
os.system("python show_result.py --gpus 0 --n 6 --t 0.6 --embed ../pkl/Order/Order_embed.pkl --classifier ../pkl/Order/Order_params.pkl")
